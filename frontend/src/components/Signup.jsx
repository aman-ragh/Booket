...
function Signup() {
  ...
  const handleSendOtp = (e) => {
    ...
    axios.post("/api/sendEmailOtp", { username }).then((res) => {
  ...
  const handleSignup = (e) => {
    ...
    axios.post("/api/signupBackend", { name, username, password, profileImageUrl })
      .then((res) => {
        console.log(res.data);
  ...
  const handleSignin = (e) => {
    e.preventDefault();
    axios.post("/api/signinBackend", { username, password })
      .then((res) => {
        // console.log(res.data);
        localStorage.clear();
